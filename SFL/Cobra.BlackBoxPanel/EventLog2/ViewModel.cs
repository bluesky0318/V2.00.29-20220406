...
namespace Cobra.BlackBoxPanel.EventLog2
{
    class ViewModel
    {
        ...
        private AsyncObservableCollection<Model> m_Event_ParameterList = new AsyncObservableCollection<Model>();
        public AsyncObservableCollection<Model> event_parameterlist
        {
            get { return m_Event_ParameterList; }
            set { m_Event_ParameterList = value; }
        }
        ...
        private void InitSFLParameter(Parameter param)
        {
            ...
            if (udata != (UInt16)LOG_TYPE.EVENT2_LOG) return;
        ...
        {
            foreach (Model param in event_parameterlist)
            {
