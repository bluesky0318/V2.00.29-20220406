...
namespace Cobra.OZE222
{
    class DEMDataManage
    {
        ...
        public void UpdateEpParamItemList(Parameter pTarget)
        {
            ...
            switch (pTarget.guid)
            {
                case ElementDefine.OTGOCP:
                    if (parent.pOTGOCP.phydata != parent.pPin8.phydata)
                        parent.pOTGOCP.phydata = parent.pPin8.phydata;
                    break;
                case ElementDefine.Pin8:
                    if (parent.pPin8.phydata != parent.pOTGOCP.phydata)
                        parent.pPin8.phydata = parent.pOTGOCP.phydata;
                    break;
            }
            return;
        }
        ...
        public void Physical2Hex(ref Parameter p)
        {
            ...
            switch ((ElementDefine.SUBTYPE)p.subtype)
            {
                ...
                case ElementDefine.SUBTYPE.WAKEUP_V:
                    {
                        wdata = (UInt16)p.phydata;
                        wdata += 0x0F;
                        ret = WriteToRegImg(p, wdata);
                ...
                case ElementDefine.SUBTYPE.VSM:
                    {
                        wdata = (UInt16)p.phydata;
                        wdata += 0x09;
                        ret = WriteToRegImg(p, wdata);
                ...
                case ElementDefine.SUBTYPE.WAKEUP_C:
                    {
                        wdata = (UInt16)p.phydata;
                ...
                case ElementDefine.SUBTYPE.EOC:
                    {
                ...
                case ElementDefine.SUBTYPE.ILMT:
                    {
                        if (p.phydata == 0)
                            wdata = 0x00;
                        else if (p.phydata == 1)
                ...
                case ElementDefine.SUBTYPE.WKT:
                    {
                        wdata = (UInt16)p.phydata;
                        ret = WriteToRegImg(p, wdata);
                        if (ret != LibErrorCode.IDS_ERR_SUCCESSFUL)
                ...
                case ElementDefine.SUBTYPE.ILMT:
                    {
                        ...
                        switch (wdata)
                        {
                            ...
                            case 0x04: p.phydata = 3; break;
                            case 0x05: p.phydata = 4; break;
                            case 0x07: p.phydata = 5; break;
                            case 0x0a: p.phydata = 6; break;
