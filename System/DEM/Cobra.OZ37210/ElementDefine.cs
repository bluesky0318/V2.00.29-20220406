...
namespace Cobra.OZ37210
{
    ...
    public class ElementDefine
    {
        ...
        internal const byte THM0_ADC_1T_Reg = 0x56;
        internal const byte THM1_ADC_1T_Reg = 0x57;
        ...
        internal const UInt32 Cell1_Offset_Trim = 0x0003950A;

        internal const UInt32 CellVoltage02 = 0x00036200;
        internal const UInt32 Cell2_Slope_Trim = 0x00039505;
        internal const UInt32 Cell2_Offset_Trim = 0x0003960A;

        internal const UInt32 CellVoltage03 = 0x00036300;
        internal const UInt32 Cell3_Slope_Trim = 0x00039600;
        internal const UInt32 Cell3_Offset_Trim = 0x0003970A;

        internal const UInt32 CellVoltage04 = 0x00036400;
        internal const UInt32 Cell4_Slope_Trim = 0x00039605;
        internal const UInt32 Cell4_Offset_Trim = 0x0003980A;

        internal const UInt32 CellVoltage05 = 0x00036500;
        internal const UInt32 Cell5_Slope_Trim = 0x00039700;
        internal const UInt32 Cell5_Offset_Trim = 0x0003990A;

        internal const UInt32 CellVoltage06 = 0x00036600;
        internal const UInt32 Cell6_Slope_Trim = 0x00039705;
        internal const UInt32 Cell6_Offset_Trim = 0x00039A04;

        internal const UInt32 CellVoltage07 = 0x00036700;
        internal const UInt32 Cell7_Slope_Trim = 0x00039800;
        internal const UInt32 Cell7_Offset_Trim = 0x00039A0A;

        internal const UInt32 CellVoltage08 = 0x00036800;
        internal const UInt32 Cell8_Slope_Trim = 0x00039805;
        internal const UInt32 Cell8_Offset_Trim = 0x00039B04;

        internal const UInt32 CellVoltage09 = 0x00036900;
        internal const UInt32 Cell9_Slope_Trim = 0x00039900;
        internal const UInt32 Cell9_Offset_Trim = 0x00039B0A;

        internal const UInt32 CellVoltage10 = 0x00036A00;
        internal const UInt32 Cell10_Slope_Trim = 0x00039905;
        internal const UInt32 Cell10_Offset_Trim = 0x00039C04;

        internal const UInt32 Isens = 0x00037500;
        internal const UInt32 Isens_Slope_Trim = 0x00039E08;
        internal const UInt32 Isens_Offset_Trim = 0x00039305;

        internal const UInt32 ExternalTemperature0 = 0x00037600;
        internal const UInt32 EXT0_Slope_Trim = 0x00039A00;
        internal const UInt32 EXT0_Offset_Trim = 0x00039B00;

        internal const UInt32 ExternalTemperature1 = 0x00037700;
        internal const UInt32 EXT1_Slope_Trim = 0x00039C00;
        internal const UInt32 EXT1_Offset_Trim = 0x00039D00;

        internal const UInt32 VBATT = 0x00037C00;
        internal const UInt32 VBATT_Slope_Trim = 0x0003930B;
        internal const UInt32 VBATT_Offset_Trim = 0x00039D0C;
        #endregion
    }
