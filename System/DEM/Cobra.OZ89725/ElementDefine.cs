...
namespace Cobra.OZ89725
{
    ...
    public class ElementDefine
    {
        ...
        internal const UInt32 IDS_ERR_DEM_ERROR_READ_VDDA_TH_FOR_CTO = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000C;
        internal const UInt32 IDS_ERR_DEM_ERROR_WRITE_VDDA_TH_FOR_CTO = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000D;
        internal const UInt32 IDS_ERR_DEM_ERROR_EEPROM_VERIFY = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000E;
        #endregion

        public enum COBRA_PIKACHU5_WKM : ushort
        {
            EFLASHMODE_NORMAL = 0,
