...
namespace Cobra.OZ77205
{
    public class DEMDeviceManage : IDEMLib
    {
        ...
        public Parameter pE_COC_DIS = null;
        #endregion
        ...
        public Dictionary<UInt32, string> m_dynamicErrorLib_dic = new Dictionary<uint, string>()
        {
            ...
            {ElementDefine.IDS_ERR_DEM_ERROR_MODE,"Please make OZ77205 into register write mode before write mapping registers."},
        ...
        {
            ParamContainer pc = m_Section_ParamlistContainer.GetParameterListByGuid(ElementDefine.EEPROMElement);
            ...
            pO_OVUV_Scan_Rate = pc.GetParameterByGuid(ElementDefine.O_OVUV_Scan_Rate);
            ...
            pE_OVUV_Scan_Rate = pc.GetParameterByGuid(ElementDefine.E_OVUV_Scan_Rate);

            //Special parameter for EEPROM but on the virtual area, please put on the end line
            pc = m_Section_ParamlistContainer.GetParameterListByGuid(ElementDefine.VirtualElement);
            if (pc == null) return;
            pE_COC_DIS = pc.GetParameterByGuid(ElementDefine.E_COC_DIS);
        }
        ...
        private void InitialImgReg()
        {
            ...
            m_EEPROM_Guid2Name_Dic.Add(0x00021701, "Ncell");
            m_EEPROM_Guid2Name_Dic.Add(0x00021703, "CHGON_INDSG");
            m_EEPROM_Guid2Name_Dic.Add(0x00021704, "VDDA_TH");
            ...
            m_EEPROM_Guid2Name_Dic.Add(0x00021906, "UVP release");
            ...
            m_EEPROM_Guid2Name_Dic.Add(0x00021B07, "Tscan");
            m_EEPROM_Guid2Name_Dic.Add(0x00021C00, "COC_TH");
            m_EEPROM_Guid2Name_Dic.Add(0x00021C04, "Tcoc");
            m_EEPROM_Guid2Name_Dic.Add(0x00021C06, "Tsc");
            m_EEPROM_Guid2Name_Dic.Add(0x00021D00, "DOC1_TH");
            m_EEPROM_Guid2Name_Dic.Add(0x00021D04, "Tdoc1");
            m_EEPROM_Guid2Name_Dic.Add(0x00021D06, "Tdoc2");
            m_EEPROM_Guid2Name_Dic.Add(0x00021E06, "DOT/DUT release");
            m_EEPROM_Guid2Name_Dic.Add(0x00021E07, "TSO_DIS");
        }
