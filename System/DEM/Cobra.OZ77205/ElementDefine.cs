...
namespace Cobra.OZ77205
{
    ...
    public class ElementDefine
    {
        ...
        internal const UInt32 E_OVUV_Scan_Rate = 0x00021B07;
        internal const UInt32 E_OV_Dly = 0x00021B00;
        internal const UInt32 E_UV_Dly = 0x00021B02;

        internal const UInt32 E_COC_DIS = 0x000c0001;
        #endregion
        ...
        internal const UInt32 O_OVUV_Scan_Rate = 0x00022B07;
        internal const UInt32 O_OV_Dly = 0x00022B00;
        internal const UInt32 O_UV_Dly = 0x00022B02;
        #endregion
        ...
        #region 芯片常量
        internal const UInt16 EF_ATE_UTTH = 0x10;
        internal const UInt16 EF_USR_OFFSET = 0x17;
        internal const UInt16 EF_USR_TOP = 0x1E;
        internal const UInt16 USR_FROZEN_MASK = 0x30;
        internal const UInt16 USR_FROZEN_Data = 0x20;
        internal const UInt16 ATE_UTTH_MASK = 0x40;
        #endregion
        ...
        internal const UInt32 IDS_ERR_DEM_ERROR_CONFIG_ZY = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000A;
        internal const UInt32 IDS_ERR_DEM_ERROR_CONFIG_ZZ = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000B;
        internal const UInt32 IDS_ERR_DEM_ERROR_EEPROM_VERIFY = LibErrorCode.IDS_ERR_SECTION_DYNAMIC_DEM + 0x000C;
        #endregion

        public enum COBRA_MARIO5_WKM : ushort
        {
            EFLASHMODE_NORMAL = 0,
