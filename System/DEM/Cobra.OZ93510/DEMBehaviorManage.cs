...
namespace Cobra.OZ93510
{
    internal class DEMBehaviorManage
    {
                            ...
                            case "TrigOne":
                                {
                                    ...
                                    #region  添加PA0，请求来自国艳，测试使用
                                    ret = EnableTriggerScan(ElementDefine.COBRA_COMMAND_MODE.TRIGGER_SCAN_ONE_MODE,
                                        ElementDefine.TRIGGER_SCAN_REQ_SINGLE, (UInt16)ElementDefine.COBRA_TRIGGER_SCAN_CHANNEL.TRIGGER_SCAN_CHANNEL_PA0);
                                    if (ret != LibErrorCode.IDS_ERR_SUCCESSFUL) return ret;
                                    ...
                                    ret = ReadWord(0x71, ref wval);
                                    parent.m_VirtualRegImg[0x18].val = wval;
                                    parent.m_VirtualRegImg[0x18].err = ret;
                                    #endregion
                ...
                case ElementDefine.COBRA_COMMAND_MODE.TRIM_SLOPE_EIGHT_MODE:
                    {
                        ...
                        wval &= 0xF3FF;
                        wval |= 0x0400; //pa0 as ADC5
                        ret = APBWriteWord(0x03, wval);
                        if (ret != LibErrorCode.IDS_ERR_SUCCESSFUL) return ret;
                        #endregion
                        ...
                        for (int n = 0; n < 8; n++)
                        {
                            ...
                            for (int i = 0; i < demparameterlist.parameterlist.Count; i++)
                            {
                                ...
                                if (param.guid == ElementDefine.VirPA0AdcSel) continue;
                            ...
                            param = msg.task_parameterlist.GetParameterByGuid(ElementDefine.VirPA0AdcSel);
                            if (param != null)
                            {
                                ret = EnableTriggerScan(ElementDefine.COBRA_COMMAND_MODE.TRIGGER_SCAN_EIGHT_MODE,
                                    ElementDefine.TRIGGER_SCAN_REQ_SINGLE, (UInt16)ElementDefine.COBRA_TRIGGER_SCAN_CHANNEL.TRIGGER_SCAN_CHANNEL_PA0);
        ...
        public UInt32 GetSystemInfor(ref TASKMessage msg)
        {
            ...
            {
                HideParameterByGuid(ElementDefine.ExternalTemperature0, demparameterlist.parameterlist);
                HideParameterByGuid(ElementDefine.PA0, demparameterlist.parameterlist, true);
            }
            else
            {
                HideParameterByGuid(ElementDefine.ExternalTemperature0, demparameterlist.parameterlist, true);
                HideParameterByGuid(ElementDefine.PA0, demparameterlist.parameterlist);
            }
            ...
            for (int i = 0; i < demparameterlist.parameterlist.Count; i++)
            {
                ...
                switch (param.guid)
                {
                    ...
                    case ElementDefine.PA0:
                        param = GetParameterByGuid(ElementDefine.PA0_Slope_Trim, demparameterlist.parameterlist);
                        break;
                }
                if (param == null) continue;
            ...
            for (int i = 0; i < demparameterlist.parameterlist.Count; i++)
            {
                ...
                switch (param.guid)
                {
                    ...
                    case ElementDefine.PA5:
                        ...
                        break;
                    case ElementDefine.PA0:
                        param = GetParameterByGuid(ElementDefine.PA0_Offset_Trim, demparameterlist.parameterlist);
                        break;
                }
                if (param == null) continue;
