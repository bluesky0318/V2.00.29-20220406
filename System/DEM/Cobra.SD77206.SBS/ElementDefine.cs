...
namespace Cobra.SD77206.SBS
{
    ...
    internal class ElementDefine
    {
        ...
        internal const UInt16 InfoFlash_StartAddress = 0x1000;//0x5000;
        internal const UInt32 InfoeFlash_Size = 1024; //1K

        internal const UInt16 SyseFlash_StartAddress = 0x2000;//0x6000;
        internal const UInt32 SyseFlash_Size = 512;

        internal const UInt16 eFlashController_StartAddress = 0x3000;//0x7000;
