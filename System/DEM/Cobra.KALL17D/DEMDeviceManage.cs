...
namespace Cobra.KALL17D
{
    public class DEMDeviceManage : IDEMLib
    {
        ...
        private void InitialImgReg()
        {
            ...
            m_guid_slope_offset.Add(ElementDefine.OP_CELL1V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL1V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL1V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL2V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL2V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL2V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL3V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL3V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL3V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL4V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL4V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL4V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL5V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL5V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL5V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL6V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL6V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL6V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL7V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL7V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL7V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL8V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL8V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL8V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL9V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL9V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL9V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL10V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL10V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL10V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL11V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL11V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL11V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL12V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL12V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL12V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL13V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL13V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL13V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL14V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL14V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL14V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL15V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL15V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL15V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL16V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL16V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL16V_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_CELL17V, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL17V_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CELL17V_OFFSET)));         
            m_guid_slope_offset.Add(ElementDefine.OP_PACK_CUR, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_ISENSE_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_ISENSE_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_VAUX, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_VAUX_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_VAUX_OFFSET)));
            m_guid_slope_offset.Add(ElementDefine.OP_VBATT, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_VBATT_SLOP),(Parameter)null));
            m_guid_slope_offset.Add(ElementDefine.OP_CADC, Tuple.Create(OPParamlist.GetParameterByGuid(ElementDefine.OP_CADC_SLOP), OPParamlist.GetParameterByGuid(ElementDefine.OP_CADC_OFFSET)));
        }
        ...
        {
            if (String.Equals(bgworker.gm.sflname, "Trim2")) 
