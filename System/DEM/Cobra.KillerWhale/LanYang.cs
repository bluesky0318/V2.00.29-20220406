...
namespace Cobra.KillerWhale
{
    class LanYang
    {
        ...
        public UInt32 WorkMode(ElementDefine.COBRA_KILLERWHALE_WKM wkm)
        {
            UInt32 ret = LibErrorCode.IDS_ERR_SUCCESSFUL;
            lock (parent.m_lock)
            {
        ...
        protected UInt32 OnWorkMode(ElementDefine.COBRA_KILLERWHALE_WKM wkm)
        {
            byte bdata = 0;
            UInt32 ret = LibErrorCode.IDS_ERR_SUCCESSFUL;
            ...
            switch (wkm)
            {
                case ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_NORMAL:
                    {
                        ret = OnWriteByte(ElementDefine.YFLASH_WORKMODE_REG, (byte)ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_NORMAL);
                        break;
                    }
                case ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_ANALOG_TESTMODE:
                    {
                        bdata |= (byte)ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_ANALOG_TESTMODE;
                        ret = OnWriteByte(ElementDefine.YFLASH_WORKMODE_REG, bdata);
                        break;
                    }
                case ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_DIGITAL_TESTMODE:
                    {
                        bdata |= (byte)ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_DIGITAL_TESTMODE;
                        ret = OnWriteByte(ElementDefine.YFLASH_WORKMODE_REG, bdata);
                        break;
                    }
                case ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_ADC_FFTMODE:
                    {
                        bdata |= (byte)ElementDefine.COBRA_KILLERWHALE_WKM.YFLASH_WORKMODE_ADC_FFTMODE;
                        ret = OnWriteByte(ElementDefine.YFLASH_WORKMODE_REG, bdata);
                        break;
                    }
                default:
