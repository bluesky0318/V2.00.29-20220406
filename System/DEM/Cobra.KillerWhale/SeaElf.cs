                ...
                case ElementDefine.COBRA_PARAM_SUBTYPE.PARAM_CC:
                    {
                        ...
                        if (wdata < 0x06) wdata = 0x05;

                        p.phydata = (float)(wdata - 0x05);
                        break;
                    }
                case ElementDefine.COBRA_PARAM_SUBTYPE.PARAM_WAKEUP_C:
                    {
