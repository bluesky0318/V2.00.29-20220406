...
{
    public class ChargerDeviceManage
    {
        ...
        private ChargerBehaviorManage m_dem_bm = new ChargerBehaviorManage();
        private ChargerDataManage m_dem_dm = new ChargerDataManage();
        #endregion
        ...
        {
            for (ushort i = 0; i < ElementDefine.OP_MEMORY_SIZE; i++)
            {
