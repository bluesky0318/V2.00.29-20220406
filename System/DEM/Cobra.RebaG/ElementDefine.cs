...
namespace Cobra.RebaG
{
    ...
    internal class ElementDefine
    {
        ...
        #region 温度参数GUID
        //(M151020)Francis, move BusOptionsElemnt definition to BusOptions class in SharedDataTypes.cs
        //internal const UInt32 BusOptionsElement = 0x00000000;
        //internal const UInt32 BoDeviceAddress = BusOptions.BusOptionsElement + 0x0002;
        internal const UInt32 BoDevicePEC = BusOptions.BusOptionsElement + 0x0003;
        //internal const UInt32 BoDevice2Address = BusOptions.BusOptionsElement + 0x0004;
        //(E151020)
