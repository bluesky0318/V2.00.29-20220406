...
namespace Cobra.KALL14D
{
    ...
    {
        internal const UInt16 EPROM_MEMORY_SIZE = 0x20;
        ...
        internal const UInt16 TotalCellNum = 14;

        internal const int RETRY_COUNT = 5;
        internal const byte CADCRTL_REG = 0x30;
        internal const byte INTR2_REG = 0x65;
        internal const byte FinalCadcMovingData_Reg = 0x39;
        internal const byte FinalCadcTriggerData_Reg = 0x38;
        ...
        internal const UInt32 EPROM_dutr_hys = 0x00029808;
        internal const UInt32 EPROM_cut_th = 0x00029900;
        internal const UInt32 EPROM_cutr_hys = 0x00029908;
        ...
        internal const UInt32 Cell1_Slope_Trim = 0x0003A305;
        internal const UInt32 Cell1_Offset_Trim = 0x0003A30A;

        internal const UInt32 CellVoltage02 = 0x00031200;
        internal const UInt32 Cell2_Slope_Trim = 0x0003A300;
        internal const UInt32 Cell2_Offset_Trim = 0x0003A40A;

        internal const UInt32 CellVoltage03 = 0x00031300;
        internal const UInt32 Cell3_Slope_Trim = 0x0003A405;
        internal const UInt32 Cell3_Offset_Trim = 0x0003A50A;

        internal const UInt32 CellVoltage04 = 0x00031400;
        internal const UInt32 Cell4_Slope_Trim = 0x0003A400;
        internal const UInt32 Cell4_Offset_Trim = 0x0003A460A;

        internal const UInt32 CellVoltage05 = 0x00031500;
        internal const UInt32 Cell5_Slope_Trim = 0x0003A505;
        internal const UInt32 Cell5_Offset_Trim = 0x0003A70A;

        internal const UInt32 CellVoltage06 = 0x00031600;
        internal const UInt32 Cell6_Slope_Trim = 0x0003A500;
        internal const UInt32 Cell6_Offset_Trim = 0x0003A80A;

        internal const UInt32 CellVoltage07 = 0x00031700;
        internal const UInt32 Cell7_Slope_Trim = 0x0003A705;
        internal const UInt32 Cell7_Offset_Trim = 0x0003A90A;

        internal const UInt32 CellVoltage08 = 0x00031800;
        internal const UInt32 Cell8_Slope_Trim = 0x0003A600;
        internal const UInt32 Cell8_Offset_Trim = 0x0003AA0A;

        internal const UInt32 CellVoltage09 = 0x00031900;
        internal const UInt32 Cell9_Slope_Trim = 0x0003A705;
        internal const UInt32 Cell9_Offset_Trim = 0x0003AB0A;

        internal const UInt32 CellVoltage10 = 0x00031A00;
        internal const UInt32 Cell10_Slope_Trim = 0x0003A700;
        internal const UInt32 Cell1O_Offset_Trim = 0x0003AB05;

        internal const UInt32 CellVoltage11 = 0x00031B00;
        internal const UInt32 Cell11_Slope_Trim = 0x0003A805;
        internal const UInt32 Cell11_Offset_Trim = 0x0003AC0A;

        internal const UInt32 CellVoltage12 = 0x00031C00;
        internal const UInt32 Cell12_Slope_Trim = 0x0003A800;
        internal const UInt32 Cell12_Offset_Trim = 0x0003AC05;

        internal const UInt32 CellVoltage13 = 0x00031D00;
        internal const UInt32 Cell13_Slope_Trim = 0x0003A905;
        internal const UInt32 Cell13_Offset_Trim = 0x0003AD0A;

        internal const UInt32 CellVoltage14 = 0x00031E00;
        internal const UInt32 Cell14_Slope_Trim = 0x0003A900;
        internal const UInt32 Cell14_Offset_Trim = 0x0003AD05;

        internal const UInt32 Isens = 0x00031f00;
        internal const UInt32 Isens_Slope_Trim = 0x0003AF00;
        internal const UInt32 Isens_Offset_Trim = 0x0003B008;

        internal const UInt32 VBATT = 0x00032100;
        internal const UInt32 VBATT_Slope_Trim = 0x0003AA00;
        internal const UInt32 VBATT_Offset_Trim = 0x0003AF08;

        internal const UInt32 THM = 0x00032300;
        internal const UInt32 THM_Slope_Trim = 0x0003AA05;
        internal const UInt32 THM_Offset_Trim = 0x0003AE0A;
        ...
        internal const UInt32 Op_dutr_hys = 0x0003B808;
        internal const UInt32 Op_cut_th = 0x0003B900;
        internal const UInt32 Op_cutr_hys = 0x0003B908;
        ...
        internal const UInt32 Op_0v_chg_disable_th = 0x0003BC08;
        #endregion
    }
