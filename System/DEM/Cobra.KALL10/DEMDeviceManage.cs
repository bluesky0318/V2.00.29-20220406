...
namespace Cobra.KALL10
{
    public class DEMDeviceManage : IDEMLib
    {
        ...
        public Parameter[] Cell = new Parameter[10];
        ...
        {
            {ElementDefine.IDS_ERR_DEM_POWERON_FAILED,"Turn on 6.5V programming voltage failed!"},
            {ElementDefine.IDS_ERR_DEM_POWEROFF_FAILED,"Turn off 6.5V programming voltage failed!"},
        ...
        public void Init(ref BusOptions busoptions, ref ParamListContainer deviceParamlistContainer, ref ParamListContainer sflParamlistContainer)
        {
            ...
            m_dem_bm.Init(this, new Communication.CCommunicateManager());
            m_dem_dm.Init(this);
