...
namespace Cobra.BlueWhale
{
    internal class DEMBehaviorManage
    {
        ...
        public UInt32 GetRegisteInfor(ref TASKMessage msg)
        {
			...
			//(A151002)Francis, read ChargeEndCurrent and convert to physical value and save in sm.misc[0]
			ret = m_charger_device.ReadOneByte(0x12, ref bdata);
			if (ret == LibErrorCode.IDS_ERR_SUCCESSFUL)
			{
				msg.sm.misc[0] = (UInt16)((int)(bdata & 0x3F) * 10);
				msg.sm.parts[0] = true;
			}
			else
			{
				msg.sm.misc[0] = 100;   //a default value
