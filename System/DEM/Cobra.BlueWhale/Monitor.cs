...
namespace Cobra.BlueWhale
{
    class Monitor
    {
                ...
                case ElementDefine.COBRA_PARAM_SUBTYPE.PARAM_EXT_TEMP:
                    {
                        ...
                        {
                            p.phydata = p.phydata * ext_therm * 1000 * parent.parent.pullupR * 1000 / (1800 * ext_therm * 1000 - p.phydata * ext_therm * 1000 - p.phydata * parent.parent.pullupR * 1000);
                            p.phydata = parent.ResistToTemp(p.phydata);
                        }
                        break;
                    }
        ...
        private UInt32 GetNTCTypeFromImg(ref byte pval)
        {
			...
			if (this.parent.m_charger_device.parent.parent.m_MonOpRegImg[0x30].err != LibErrorCode.IDS_ERR_SUCCESSFUL)
			{
				u32Ret = parent.m_charger_device.ReadOneByte(0x30, ref yVal);
				parent.m_charger_device.parent.parent.m_MonOpRegImg[0x30].err = u32Ret;
				parent.m_charger_device.parent.parent.m_MonOpRegImg[0x30].val = (UInt16)yVal;
			}
			//(E150806)
            pval = (byte)(this.parent.m_charger_device.parent.parent.m_MonOpRegImg[0x30].val & 0x01);
            return this.parent.m_charger_device.parent.parent.m_MonOpRegImg[0x30].err;
        }
        ...
        private bool IsCharging()
        {
			...
			{
				u32Ret = parent.m_charger_device.ReadOneByte(0x40, ref yVal);
				parent.m_charger_device.parent.parent.m_MonOpRegImg[0x40].err = u32Ret;
				parent.m_charger_device.parent.parent.m_MonOpRegImg[0x40].val = (UInt16)yVal;
			}
			//(E150806)
			
			return (this.parent.m_charger_device.parent.parent.m_MonOpRegImg[0x40].val & 0x20) == 0x20;
        }
