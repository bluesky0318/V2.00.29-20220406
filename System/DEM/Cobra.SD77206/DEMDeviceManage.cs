...
namespace Cobra.SD77206
{
    public class DEMDeviceManage : IDEMLib2
    {
        ...
        public struct Cell_Offset
        {
            public UInt16 Cell_1nd_hex;
            public double Cell_1nd_offset;
            public UInt16 Cell_2nd_hex;
            public double Cell_2nd_offset;
        };
        public Cell_Offset Cell1_Offset, Cell2_Offset;
        ...
        public List<byte> m_MTPSpecial_RegList = new List<byte>() {0x09, 0x0E, 0x0F };
        ...
        public UInt32 GetINT25Ref(ref double ddata)
        {
            ...
            ret = m_dem_bm.SysReadDWord(0x0E, ref wval);
