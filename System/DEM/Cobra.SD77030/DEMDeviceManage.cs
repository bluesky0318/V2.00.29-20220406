...
namespace Cobra.SD77030
{
    public class DEMDeviceManage : IDEMLib
    {
        ...
        public ElementDefine.Forzen_struct m_forzen_struct;
        ...
        {
            {ElementDefine.IDS_ERR_DEM_EFUSE_CFGFRZ,"EFUSE 0x03 is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_EFUSE_BANK1,"EFUSE 0x04~0x09 is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_EFUSE_BANK2,"EFUSE 0x0A~0x0F is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_MAP_CFGFRZ,"EFUSE Map 0x03 is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_MAP_BANK1,"EFUSE Map 0x04~0x09 is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_MAP_BANK2,"EFUSE Map 0x0A~0x0F is frozen,Can't be written!"},
            {ElementDefine.IDS_ERR_DEM_OPERATE_ONE_PARAM_DISABLE,"Don't support to operate one parameter."},
            {ElementDefine.IDS_ERR_DEM_ERROR_MODE,"Please make Warriors into register write mode before write mapping registers."},
        };
        #endregion
